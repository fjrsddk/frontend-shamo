...
Color disableColor = Color(0xff0808191);
...
Color backgroundColor6 = Color(0xffECEFEF);
...
Color indicatorColor = Color(0xffC4C4C4);
...
TextStyle bubbleTextStyle = GoogleFonts.poppins(
